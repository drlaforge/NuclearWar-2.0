...
varargs void remove_message(string owner, string lsub, int ldate, int orig_flag)
{
   int mn;
   int i;
   string flag;
   ...
   if(flag)
      remove_message(flag,lsub,ldate,1);
}

int
add_message(string owner, mixed lto, mixed lcc, string lfrom, string lsubject,
...
string *
send_mail(string *lto, string *lcc, string lfrom, string lsubject, int ldate,
               string lmessage)
{
   int i, lref_cnt;
   string *tmpto;
