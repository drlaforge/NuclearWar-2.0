 ...
 */
#define MASTER_NAME              "secure/obj/master"
 ...
 */
#define WIZLIST_FILE  "secure/wiz/WIZLIST"
 ...
 */
#define ACCESS_FILE "secure/wiz/ACCESS.ALLOW"

/* logfile to show valid and rejected connections
 * simple not define this for NO logs
 */
#define ACCESS_LOG      "secure/log/access.allow.log"
...
#undef   TLS_DEFAULT_KEYDIRECTORY   
 ...
 */
#define PYTHON_STARTUP_SCRIPT "startup.py"
