...
#line 10725 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | '&' '(' lvalue ')'
#line 10731 "prolang.y"
      {
          $$ = $3;
      }
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | '&' '(' function_call ')'
#line 10736 "prolang.y"
      {
...
struct_init:
      identifier ':' expr0
#line 12271 "prolang.y"
      {
          $$.name = $1;
          $$.type = $3.type;
      }
    | expr0
#line 12276 "prolang.y"
      {
          $$.name = NULL;
          $$.type = $1.type;
      }
